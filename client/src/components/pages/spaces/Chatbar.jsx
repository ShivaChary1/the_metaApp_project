...
//         setAllMessages(response.data.chats?.chats || []);
//       } catch (err) {
//         console.error('Cannot fetch chats:', err);
//       }
//     };
...
//           },
//         ];
//         // Scroll to bottom only if the message is from the current user or user is near bottom
//         const chatContainer = chatContainerRef.current;
//         if (chatContainer) {
//           const isNearBottom =
//             chatContainer.scrollHeight - chatContainer.scrollTop - chatContainer.clientHeight < 50;
//           if (userId === user?.userId || isNearBottom) {
//             setTimeout(() => {
...
//                 <div
//                   className={`max-w-xs px-3 py-2 rounded-lg text-sm shadow-md ${
//                     isCurrUser ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-800'
//                   }`}
//                 >
//                   {!isCurrUser && (
//                     <div className="font-semibold text-xs mb-1">
