...
//         <button className="rounded cursor-pointer whitespace-nowrap bg-transparent border border-purple-500 text-white font-semibold py-2 px-6 hover:bg-purple-500/10 transition-all duration-300">
